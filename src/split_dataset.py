...
def run_split_dataset(tracking_uri, experiment_name, run_name, perc_data_test=0.3, random_state=42):
    ...
    with mlflow.start_run(run_name=run_name) as parent_run:
        ...
        with mlflow.start_run(run_name="split_data", nested=True) as split_run:
            split_run_id = split_run.info.run_id
            mlflow.log_param("perc_data_test", perc_data_test)
            ...
            mlflow.log_artifact("data/out/clientes_data_train.csv", artifact_path="data/out")
            mlflow.log_artifact("data/out/clientes_data_test.csv", artifact_path="data/out")
            mlflow.log_artifact("data/out/requerimientos_data_train.csv", artifact_path="data/out")
            mlflow.log_artifact("data/out/requerimientos_data_test.csv", artifact_path="data/out")
    return parent_run_id, split_run_id 
