...
def process_preprocess_dataset(y_col):
    if (os.getcwd().endswith('src')):
        os.chdir("..")
    df_data_train = pd.read_csv("data/out/clientes_data_train.csv")
    df_requerimientos_train = pd.read_csv("data/out/requerimientos_data_train.csv")
...
def main():
    y_col = "ATTRITION"
    process_preprocess_dataset(y_col)
