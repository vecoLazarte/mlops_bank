...
default_path = 'mlops-chester/sagemaker/bank-attrition-detection'
...
def lambda_handler(event, context):
    ...
    return {
        'statusCode': 200,
        'body': json.dumps({'prediction': str(clase)})
    } # se retorna, si sale 200 es porque todo ok y se convierte en diccionario la salida
